...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.till'
        db.add_column('orders_order', 'till', self.gf('django.db.models.fields.DateTimeField')(default='2011-12-29 14:36:00'), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Order.till'
        db.delete_column('orders_order', 'till')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'till': ('django.db.models.fields.DateTimeField', [], {}),
