...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("ALTER TABLE auth_user ENGINE=InnoDB")
        ...
        db.create_table('users_userprofile', (
            ...
            ('identity', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ))
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identity': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
