...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_itemimage', 'item', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.Item']), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'ItemImage.item'
        db.delete_column('catalog_itemimage', 'item_id')
