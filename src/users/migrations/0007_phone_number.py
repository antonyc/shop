...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'UserProfile.phone_number'
        db.delete_column('users_userprofile', 'phone_number')
